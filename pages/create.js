					...
					<Col css={{ marginRight: '$7' }}>
						...
						<Card css={{ marginTop: '$5', marginBottom: '$5' }}>
							<Card.Body style={{ backgroundColor: '#00000040' }}>
								<Text>
									Select your Preferred Network, Create your Amazing NFT by uploading your
									art using the simple NFT Dashboard. Simple!
								</Text>
							</Card.Body>
						</Card>
						...
						<Card css={{ marginTop: '$5' }}>
							<Card.Body style={{ backgroundColor: '#00000040' }}>
								<Text>
									A Simplified Web3 Marketplace built with the power and security of
									AlchemY SDK.
								</Text>
							</Card.Body>
						</Card>
